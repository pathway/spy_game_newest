...
"""
## load vars
places = u.load_data("places")
items = u.load_data("items")
craft_items = u.load_data("craft_items")
npcs = u.load_data("npcs")
entities = u.load_data("entities")


plot_moves = u.load_data("plot_moves")
state = {}

moves = u.load_data("moves/moves")
execs = u.load_data("moves/execs")
